...
/**
 * This handler handles adding address to user's address list.
...
/**
 * This handler handles removing address from user's address list.
...
/**
 * This handler handles updating address in user's address list.
...
export const updateAddressHandler = function (schema, request) {
  ...
  try {
    ...
    const userAddress = schema.users.findBy({ _id: userId }).address;
    const {
      address: { name, locality, city, state, pincode, mobile, email },
